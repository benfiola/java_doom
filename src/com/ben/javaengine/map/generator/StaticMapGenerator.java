...
public class StaticMapGenerator {
	...
	public static Map generateMap() {
		...
		walls.add(new Wall(new Vertex(20.0, 20.0), new Vertex(30.0, 20.0), 50.0, 0.0));
		walls.add(new Wall(new Vertex(0.0,0.0), new Vertex(40.0, 0.0), 50.0, 0.0));
		walls.add(new Wall(new Vertex(40.0, 0.0), new Vertex(40.0, 40.0), 50.0, 0.0));
		walls.add(new Wall(new Vertex(40.0, 40.0), new Vertex(0.0, 40.0), 50.0, 0.0));
		walls.add(new Wall(new Vertex(0.0, 40.0), new Vertex(0.0, 0.0), 50.0, 0.0));
