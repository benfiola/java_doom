...
public class EventManager {
	...
	protected EventManager() {
		...
		Reflections reflections = new Reflections(AbstractEventPublisher.class.getPackage().getName());
		Set<Class<? extends AbstractEventPublisher>> pubClasses = reflections.getSubTypesOf(AbstractEventPublisher.class);
		for(Class<? extends AbstractEventPublisher> pubClass : pubClasses) {
			try {
				Constructor<? extends AbstractEventPublisher> toConstruct = pubClass.getConstructor();
	...
	private AbstractEventPublisher getPublisher(Class<? extends AbstractEvent> event) {
	...
	public static void publish(AbstractEvent e) {
	...
	public static void subscribe(Class<? extends AbstractEvent> eventClass, Object o) {
		EventManager instance = EventManager.getInstance();
